package com.diva.pimpaddokter.ui.chatting
...
import com.diva.pimpaddokter.adapter.ChattingAdapter
import com.diva.pimpaddokter.databinding.ActivityChattingBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reference!!.addValueEventListener(object : ValueEventListener {
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                readMessage(firebaseUser!!.uid, userId, user.profileImage)
            }
        })
