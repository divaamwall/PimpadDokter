package com.diva.pimpaddokter.ui.register
...
import com.diva.pimpaddokter.databinding.ActivityRegisterBinding
        ...
        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) {
                if (it.isSuccessful) {
                    ...
                    databaseReference = FirebaseDatabase.getInstance().getReference("Dokters").child(userId)
